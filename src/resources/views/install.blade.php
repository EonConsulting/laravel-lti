                    ...
                    <div class="card shadow">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter a Logo URL e.g http://logourl.co/logo.png"
                                       name="logo_uri" class="form-control" value="{{ old('logo_uri') }}"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Secret</label>
                                <input type="text" placeholder="Secret" name="secret" class="form-control"
                                       value="{{ old('secret') }}"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Launch URL" name="launch_url" class="form-control"
                                       value="{{ old('launch_url') }}"/>
                            </div>
                        </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Config URL" name="config_url" class="form-control"
                                       value="{{ old('config_url') }}"/>
                            </div>
                        </div>
